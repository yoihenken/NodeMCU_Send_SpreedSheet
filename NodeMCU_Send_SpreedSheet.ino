...
const char* ssid = "myname";                //replace with our wifi ssid
const char* password = "satrio2709";         //replace with your wifi password

const char* host = "script.google.com";
const char *GScriptId = "AKfycbxWA89hmJhHAWZ5QOq8NL7F91rvPDAyLsXs3v8kz7_mKklTO8w"; // Replace with your own google script id
